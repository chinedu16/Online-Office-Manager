                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Task Status <small></small>
                        </h1>
                        <ol class="breadcrumb">
                          <li class="active">
                              <i class="fa fa-dashboard"></i> How Far the task has Gone
                          </li>
                          </div>
                        </ol>
                    </div>
                            ...
                            $result = mysql_query($query);
                              ...
                              <thead>
                                ...
                                while ($row = mysql_fetch_array($result)) {
                                  ...
                                  echo "<td> $date </td>";
                                  echo "<td> $status </td>";
                                  echo "<td  href='' class='progress-bar progress-bar-success' style='width: 100%'> $testing </td>";
                                  echo "</tr>";
                                  echo "</tbody>";
